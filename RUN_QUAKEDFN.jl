...
########################## Simulation Time Set ################################
TotalStep = 4000 # Total simulation step
SaveStep = 4000 # Automatically saved every this step
RecordStep = 5 # Simulation sampling rate
...
RunRSFDFN3D(TotalStep, RecordStep, LoadingInputFileName, SaveResultFileName, RuptureTimeStepMultiple)
