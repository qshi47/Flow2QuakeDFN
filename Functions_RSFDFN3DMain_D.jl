function main(StiffnessMatrixShear, StiffnessMatrixNormal, NormalStiffnessZero,
    ...
    if  isfile("Input_ExternalStressChange.jld2")
        ...
        ExternalStress_Pressure = load("Input_ExternalStressChange.jld2", "Pressure") # Qian 2024/10/24
    ...
    History_Friction = zeros(TotalRecord,FaultCount);
        ...
        for i=1:TotalStep
            ...
            if rem(i,RecordStep)==0
                ...
                if rem(i,SaveStep)==0
                    ...
                    "History_Friction", History_Friction,
