...
function BuildBulk()
    ...
    # Fault parameters
    Phi = 70 # deg (Conventional Dip Angle, counter-clockwise from XY plane)
    DipAngle = 180.0 - Phi # deg (QuakeDFN Dip Angle, clockwise from XY plane)
    StrikeAngle = 90.0 # deg (Conventional&QuakeDFN Strike Angle, counter-clockwise from +X)
    FaultCenterX = 2000
    FaultCenterY = 0
    FaultCenterZ = 4000
    LengthDip = 500
